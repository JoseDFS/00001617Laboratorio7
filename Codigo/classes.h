...
enum parameters {T,KAPPA,LAMBDA,V,TRIDENT,DELTA,ETA,EXTERNAL_FORCE_Y,EXTERNAL_FORCE_X};
...
class mesh{
    ...
    public:
        void setParameters(float t,float k, float lambda,float v,float trident,float delta,float eta){
            parameters[T]=t;
            parameters[KAPPA]=k;
            parameters[LAMBDA]=lambda;
            parameters[V]=v;
            parameters[TRIDENT]=trident;
